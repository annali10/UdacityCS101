...
def daysInMonth(year, month):
    if isLeapYear(year) and (month == 2): 
        return 29
    # create tuple with all correct days in months except during leap year
    monthTuple = (31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
    # returns corresponding days in month. takes into account index starts at 0
    return monthTuple[month - 1]
