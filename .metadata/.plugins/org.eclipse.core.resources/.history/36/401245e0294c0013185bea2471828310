...
''' Pseudo code:
First crawl all links on the seed (i = 0) page. If the max_depth > 0, 
then crawl all the links on every page that is linked on the seed page. 
If max_depth > 2, then go from the pages that were linked from seed (i = 1) page
and collect all of those links. Continue until the i is equal to max_depth.
Then return all the links 
